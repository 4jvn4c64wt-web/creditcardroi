...
7. If the card will be featured in an insights article, follow [Playbook H](#18-playbook-h-publishing-a-new-insights-article) and ensure the article's fees/multipliers match the card definition
8. Test: upload a CSV, map the card, verify multipliers on known merchants
