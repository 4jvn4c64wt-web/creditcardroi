...
document.addEventListener('DOMContentLoaded', async () => {
      ...
      if (confirm('This action CANNOT be undone. Type "DELETE" in the next prompt to confirm.')) {
        ...
        if (confirmation === 'DELETE') {
          ...
          if (versionChoice === '2') {
            ...
            alert('Switched to Decision Pass. Redirecting...');
            window.location.href = 'app.html';
            ...
            alert('Switched to Pro. Reloading...');
            window.location.reload();
          } else {
            // Base version - clear all tier access
            state.decisionPasses = [];
            state.proAccess = null;
            alert('Switched to Base version. Redirecting...');
            window.location.href = 'app.html';
          }
  ...
  document.getElementById('exportData').addEventListener('click', () => {
    ...
    // Gate export: Pro has full access, no gate needed
