...
window.CardTracker.cards['chase-sapphire-preferred'] = {
  ...
  baseRate: 1,
  credits: [
    { name: 'Hotel Credit (Chase Travel)', amount: 50, keywords: ['CHASE TRAVEL'], manual: false, frequency: 'annual' },
    { name: 'DoorDash Grocery Credit', amount: 120, keywords: [], manual: true, frequency: 'monthly' }, // $10/month in-app
